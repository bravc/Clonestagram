...
//
//            guard let token = try? UserManager.shared.keychain.get("auth_token") else {
//                return
//            }
//
//
...
//
//            }, usingThreshold: UInt64.init(), to: NetworkManager.shared.apiURL + "/api/posts", method: .post, headers: headers) { (result) in
//                switch result {
